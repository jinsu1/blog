...
5.모양 > 테마 > 원하는 테마 추가 > child테마 플러그인 사용하여 적용
...
7.UpdraftPlus 설치 (망보드는 backup.php수정해야 백업된다. 위에 설명 있음)
8.모든 백업 파일 업로드 후 복원
...
-simply static : ui만 복사하여 html파일로 저장
...
5.vscode로 열어서 라이브 서버 확인해보고(path:/로해야 라이브서버 확인 가능하고 깃허브에는 위 2번처럼 해야나온다.) github 레포에 업로드
...
-git init
-git branch -M main
-git remote add origin git@github.com:onsshopi/grouping1.git
-푸쉬 진행
